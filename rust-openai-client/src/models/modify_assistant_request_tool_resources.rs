...
pub struct ModifyAssistantRequestToolResources {
    ...
    pub code_interpreter: Option<Box<models::ModifyAssistantRequestToolResourcesCodeInterpreter>>,
    #[serde(rename = "file_search", skip_serializing_if = "Option::is_none")]
    pub file_search: Option<Box<models::ModifyAssistantRequestToolResourcesFileSearch>>,
}
