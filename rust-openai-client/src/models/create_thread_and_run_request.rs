...
pub struct CreateThreadAndRunRequest {
    ...
    pub thread: Option<Box<models::CreateThreadRequest>>,
    ...
    pub tools: Option<Option<Vec<models::CreateThreadAndRunRequestToolsInner>>>,
    #[serde(rename = "tool_resources", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tool_resources: Option<Option<Box<models::CreateThreadAndRunRequestToolResources>>>,
